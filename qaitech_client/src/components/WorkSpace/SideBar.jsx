...
const SideBar = () => {
  ...
  const { data, setData, test, updateData } = useContext(PagesContext);
  ...
  return (
    <>
      {/* search */}
      <div className="h-full px-[12px] py-[8px] overflow-hidden flex flex-row gap-[12px] items-center">
      ...
      <MacScrollbar
        ...
        thumbStyle={() => ({
          backgroundColor: "#515677", // This style is an inline style, I will leave it as is for now.
        })}
      >
        {/* {data?.map((i, key) => (
